select distinct
  ...
  cmq_base.status,
  cmq_base.state,
  to_char(cmq_base.creation_date, 'DD-MON-YYYY:hh:MI:SS AM') as creationDate,
  cmq_base.created_by as createdBy,
  cmq_base.algorithm,
  cmq_base.last_activation_date,
  to_char(cmq_base.last_activation_date, 'DD-MON-YYYY:hh:MI:SS AM') as lastActivationDate,
