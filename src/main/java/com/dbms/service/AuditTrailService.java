...
public class AuditTrailService implements IAuditTrailService{
	...
	@Override
	public List<AuditTrailDto> findByCriterias(Long listCode, String listName, int dictionaryVersion,
...
//	 				+"  UNION "
	 				...
	 				+"    and audit_timestamp <= :auditTimeStampString"
                                +"  UNION "
	 				+"  SELECT CMQ_ID "
	 				+"  , TO_CHAR(TERM_CATEGORY2_New) NEW "
	 				+"  , TO_CHAR(TERM_CATEGORY2_old) OLD "
	 				+"  , TRANSACTION_ID "
	 				+"  , TRANSACTION_TYPE "
	 				+"  , FIRST_NAME "
	 				+"  , LAST_NAME "
	 				...
	 				+"  , GROUP_NAME "
	 				+"  , AUDIT_TIMESTAMP "
	 				+"  ,'TERM_CATEGORY2' column_name "
	 				+"  ,'CMQ_RELATIONS_"+dictionaryVersion+"_AUDIT' table_name "
	 				+"  FROM CMQ_RELATIONS_"+dictionaryVersion+"_AUDIT cba "
	 				+"  WHERE NVL(TO_CHAR(TERM_CATEGORY2_New),'xoxox') <> NVL(TO_CHAR(TERM_CATEGORY2_OLD),'xoxox') "
	 				+"      and exists "
	 				+"        (select 1 from "
	 				+"         CMQ_BASE_"+dictionaryVersion+" "
	 				+"         where cmq_name = :listName "
	 				...
	 				+"  SELECT CMQ_ID "
	 				+"  , (select DISTINCT codelist_value from ref_config_codelist  "
	 				+"     where codelist_configuration_type ='PATH_FILTER_LEVELS' "
	 				+"     and codelist_internal_value = cba.TERM_PATH_NEW "
	 				+"     and active_flag='Y' "
	 				+"     UNION ALL "
	 				+"     select DISTINCT codelist_internal_value from ref_config_codelist  "
	 				+"     where "
	 				+"        active_flag='N' "
	 				+"        and codelist_configuration_type = 'PATH_FILTER_LEVELS' "
	 				+"        and serialnum =  "
	 				+"            (select max(serialnum) from ref_config_codelist "
	 				+"             where codelist_configuration_type = 'PATH_FILTER_LEVELS' "
	 				+"             and codelist_internal_value = cba.TERM_PATH_NEW "
	 				...
	 				+"  , (select DISTINCT codelist_value from ref_config_codelist  "
	 				+"     where codelist_configuration_type ='PATH_FILTER_LEVELS' "
	 				+"     and codelist_internal_value = cba.TERM_PATH_OLD "
	 				+"     and active_flag='Y' "
	 				+"     UNION ALL "
	 				+"     select DISTINCT codelist_internal_value from ref_config_codelist  "
	 				+"     where "
	 				...
	 				+"  , GROUP_NAME "
	 				+"  , AUDIT_TIMESTAMP "
	 				+"  ,'TERM_PATH' column_name "
	 				+"  ,'CMQ_RELATIONS_"+dictionaryVersion+"_AUDIT' table_name "
	 				+"  FROM CMQ_RELATIONS_"+dictionaryVersion+"_AUDIT cba "
	 				+"  WHERE NVL(TO_CHAR(TERM_PATH_New),'xoxox') <> NVL(TO_CHAR(TERM_PATH_OLD),'xoxox') "
	 				+"      and exists "
	 				+"        (select 1 from "
	 				+"         CMQ_BASE_"+dictionaryVersion+" "
	 				+"         where cmq_name = :listName "
